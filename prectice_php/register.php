...
<head>
  ...
  <title>Capsiform Admin Registration</title>
...
<body style="background-image: url('images/bgimg2.jpg')" class="bg-cover bg-center">

  <!-- Navbar Section for Capsiform -->
  <nav class="bg-transparent fixed w-full px-4 z-20 top-0 left-0 sm:block hidden">
  ...
  <div class="h-screen flex items-center justify-center bg-cover bg-center">
    <div class="bg-transparent border-2 border-gray-200 text-center rounded-xl p-6 w-full sm:w-[380px] md:w-[400px]">
      ...
      <form id="registration_form" action="reg.php" method="POST" onsubmit="return validForm()">
        ...
        <div class="text-left h-[6.2rem] mb-3">
        ...
        <div class="text-left relative h-[6.2rem] mb-3">
        ...
        <div class="mb-3 text-left relative h-[6.4rem] mb-3">
      ...
      <p class="text-lg my-4 text-white">
        ...
        <a href="login.php" class="hover:underline active:text-blue-700">Login Now</a>
      </p>
    </div>
  </div>
